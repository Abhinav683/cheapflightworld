  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col w-full max-w-6xl gap-16 md:gap-24 lg:gap-46">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight text-[#6A7181] font-semibold leading-none">
              Luxury.
            </h1>

            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight text-[#1C2534] font-bold leading-none opacity-90">
              Affordable.
            </h1>
